...
def main():
    ...
    ap.add_argument('-p', '--port', required=False, type=int, default=8002, help='TCP port to listen on (default 8002 - ignored if -s)')
    ap.add_argument('-s', '--stdio', required=False, default=False, action="store_true", help='Start an STDIO server (default: off)')
    args = ap.parse_args()
